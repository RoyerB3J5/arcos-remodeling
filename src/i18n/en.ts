export default {
  header: {
    nav: [
      {
        label: 'Services <span class="text-[16px] ml-px">▾</span>',
        href: '/services',
      },
      {
        label: 'About us',
  ...
  main: {
    hero: {
      title:
        'Interior & Exterior <br class="hidden sm:block"/> Painting and Drywall <br class="hidden sm:block"/> Services in New Mexico',
      description: 'Trusted Home Experts',
      buttons: [
        {
          icon: 'arrow',
          label: 'Book Now!',
    ...
    benefits: [
      {
        ...
        description:
          'Over 8 years delivering high-quality painting and drywall services ',
      },
      {
        icon: 'benefit-2',
        title: 'Quality First',
        ...
        description:
          'Every project is completed with care, respect, and a strong focus  ',
      },
      {
        icon: 'benefit-3',
        title: 'Local Service',
        subtitle: 'New Mexico Homes',
        description:
          'Proudly serving homeowners across New Mexico with reliable and professional service.',
      },
    ],
    services: {
      title:
    ...
    request: {
      ...
      description:
        'Thank you for choosing Arcos Remodeling Home Improvement. If these times don’t work, call or text <a href="tel:+15052079968">+1 (505) 207-9968</a> and we’ll help coordinate your project.',
    },
    why: {
      title: 'Why Choose <br class="hidden sm:block"/> Arcos Remodeling',
      description:
        'At Arcos Remodeling Home Improvement, we treat every project with esponsibility, precision, and respect. From the first contact to the final detail, our goal is to deliver quality work that meets your expectations and improves your home.',
      items: [
        {
          icon: 'why-1',
          title: 'Quality Craftsmanship',
          description:
            'We focus on clean finishes, precise details, and durable results that enhance the look and value of your home.',
        },
        {
          icon: 'why-2',
          title: 'On-Time & Professional',
          description:
            'We respect your time and your space, delivering organized, punctual, and professional service on every project.',
        },
      ],
    },
    process: {
